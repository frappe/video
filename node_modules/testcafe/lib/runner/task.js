...
var Task = function (_EventEmitter) {
    ...
    function Task(tests, browserConnections, proxy, opts) {
        ...
        _this.fixtureHookController = new _fixtureHookController2.default(tests, browserConnections.length);
    ...
    Task.prototype._createBrowserJobs = function _createBrowserJobs(proxy, opts) {
        ...
        return this.browserConnections.map(function (bc) {
            var job = new _browserJob2.default(_this3.tests, bc, proxy, _this3.screenshots, _this3.warningLog, _this3.fixtureHookController, opts);
