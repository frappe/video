...
var BrowserSet = function (_EventEmitter) {
    ...
    function BrowserSet(connections) {
        ...
        connections.forEach(function (bc) {
                    ...
                    switch (_context3.prev = _context3.next) {
                        case 0:
                            isLocalBrowser = function isLocalBrowser(connection) {
                                return connection.provider.plugin.isLocalBrowser();
                            };

                            _context3.next = 3;
                            return _pinkie2.default.all(this.connections.map(isLocalBrowser));
            ...
            return _regenerator2.default.wrap(function _callee4$(_context4) {
                while (1) {
                    switch (_context4.prev = _context4.next) {
                        case 0:
                            connectionsReadyPromise = _pinkie2.default.all(this.connections.filter(function (bc) {
                                return !bc.opened;
                            }).map(function (bc) {
    ...
    BrowserSet.prototype._checkForDisconnections = function _checkForDisconnections() {
        var disconnectedUserAgents = this.connections.filter(function (bc) {
            return bc.closed;
        }).map(function (bc) {
            return bc.userAgent;
        });
    ...
    BrowserSet.from = function from(connections) {
        var _this2 = this;
    ...
    BrowserSet.prototype.releaseConnection = function releaseConnection(bc) {
        ...
        if (this.connections.indexOf(bc) < 0) return _pinkie2.default.resolve();

        (0, _lodash.pull)(this.connections, bc);
                ...
                while (1) {
                    switch (_context6.prev = _context6.next) {
                        case 0:
                            ...
                            (0, _mapReverse2.default)(this.connections, function (bc) {
