...
exports.DIRECTIVE_EXPRESSION_AST_PATH = ['toplevel', 'stat'];

exports.TEST_AND_MIXIN_DECLARATION_AST_PATH = ['toplevel', 'stat', ['assign', true], 'sub'];

exports.ACTION_FUNC_AST_PATH = ['function', 'stat'];
...
exports.DIRECTIVE_LVALUES = [exports.AUTH_DIRECTIVE_LVALUE, exports.FIXTURE_DIRECTIVE_LVALUE, exports.PAGE_DIRECTIVE_LVALUE, exports.REQUIRE_DIRECTIVE_LVALUE];
