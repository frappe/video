...
exports.default = getEncodingName;
...
var LOOKUP_TABLE = (0, _keys2.default)(ENCODING_LABELS).reduce(function (table, encoding) {
    ENCODING_LABELS[encoding].forEach(function (label) {
...
function getEncodingName(label) {
    if (label) {
        label = (0, _stringTrim2.default)(label.toLowerCase());
